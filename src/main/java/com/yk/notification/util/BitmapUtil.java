...
public final class BitmapUtil {
	 ...
	 */
	public static Bitmap safeDecodeStream(Uri uri, int targetWidth,
			int targetHeight, Context mContext) throws FileNotFoundException {
		BitmapFactory.Options options = new BitmapFactory.Options();
		android.content.ContentResolver resolver = mContext
				.getContentResolver();
		options.inJustDecodeBounds = true;
	...
	public  static Bitmap createRoundImageWithBorder(Context context, Bitmap bitmap){
		...
		Bitmap roundedBitmap = Bitmap.createBitmap(newBitmapSquareWidth,
		...
		RoundedBitmapDrawable roundedBitmapDrawable =
				RoundedBitmapDrawableFactory.create(context.getResources(),roundedBitmap);
