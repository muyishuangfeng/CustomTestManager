package com.yk.notification.thread;
...
public class GetGpsThread extends Thread{
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation loc) {
            if (null != loc) {
                //解析定位结果
                GetGpsBean getGpsBean= new GetGpsBean();
                ...
                sendMessage(MessageBox.MESSAGE_LOCATION_SU, getGpsBean);
            } else {
                sendMessage(MessageBox.MESSAGE_LOCATION_ERROR, loc.getErrorInfo());
            }
        }
    };
